...
if __name__ == '__main__':
    ...
    #                 traj_len, save_fig_name="fake_gail")
    ...
    flat_state_arr, action_arr = model_inference_env(actor_critic.mlp_policy_net, num_trajs, traj_len, state_len=5, radii=[-10,-10, -10], render=True)
